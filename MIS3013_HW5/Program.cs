...
DeveloperInformation("jack chavers", "MIS 3013 HW5");
...
string GetMenu()
{
    ...
    rStr = string.Format($"{rStr}1.Subtract\n");
    rStr = string.Format($"{rStr}1.Multiply\n");
    rStr = string.Format($"{rStr}1.Divide\n");
    rStr = string.Format($"{rStr}1.Factorial\n");
    rStr = string.Format($"{rStr}1.RaisePower\n");
    rStr = string.Format($"{rStr}1.Press other keys to exit\n\n");
...
{
    //Developer:Jack Chavers for class MIS 3013 HW5
